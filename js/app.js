(() => {
    ...
    class Popup {
        ...
        eventsPopup() {
            document.addEventListener("click", function(e) {
                ...
                document.querySelector(".gallery__arrows");
                ...
                if (!e.target.closest(".gallery__arrows") && !e.target.closest(".gallery__slider") && !e.target.closest(".popup__content")) this.close();
            }.bind(this));
    ...
    function rangeInit() {
        ...
        if (priceSlider) {
            ...
            priceSlider.noUiSlider.set([ "30", "110" ]);
            let formatValues = [ document.getElementById("fromThis"), document.getElementById("toThis") ];
    ...
    function initSliders() {
        ...
        if (document.querySelector(".category__slider")) new core(".category__slider", {
            ...
            loop: true,
            navigation: {
                prevEl: ".slider-category__arrows .slider-arrow_prev",
                nextEl: ".slider-category__arrows .slider-arrow_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1
        ...
        if (document.querySelector(".deal__slider")) new core(".deal__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
            ...
            speed: 1300,
            navigation: {
                prevEl: ".deal__arrows .slider-arrow_prev",
                nextEl: ".deal__arrows .slider-arrow_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1
        ...
        if (document.querySelector(".latest__slider")) new core(".latest__slider", {
            ...
            loop: true,
            navigation: {
                prevEl: ".latest__arrows .slider-arrow_prev",
                nextEl: ".latest__arrows .slider-arrow_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1
        ...
        if (document.querySelector(".gallery__slider")) {
            const swiper = new core(".gallery__slider", {
                modules: [ Navigation ],
                slidesPerView: 1,
                spaceBetween: 100,
                speed: 1200,
            ...
            for (let i = 0; i < galleryImages.length; i++) galleryImages[i].addEventListener("click", (() => {
                swiper.slideTo(i);
                console.log(i);
    ...
    if (document.querySelector(".search__button")) {
        ...
        document.addEventListener("click", (e => {
            ...
            if (target !== searchButton && target !== searchInput) searchInput.classList.remove("_show");
        }));
    }
    window.onload = function() {
        ...
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.closest(".item-list__cart") || targetElement.closest(".item-deal__button")) {
        ...
        function addToCart(productButton, productId) {
            if (!productButton.classList.contains("_hold")) {
                ...
                product.querySelector(".item-list__price span").innerHTML;
        ...
        function updateCart(productButton, productId, productAdd = true) {
            ...
            document.querySelector(".cart-header__icon");
            ...
            if (productAdd) {
                ...
                if (!cartProduct) {
                    const product = document.querySelector(`[data-pid="${productId}"]`);
                    const productPrice = product.querySelector(".item-list__price span").innerHTML;
                    cartPrice.innerHTML = (+cartPrice.innerHTML + +productPrice).toFixed(2);
                    const cartProductImage = product.querySelector(".product-image").innerHTML;
                    const cartProductTitle = product.querySelector(".product__title").innerHTML;
                    const cartProductContent = `\n\t\t\t\t<a href="" class="cart-list__image-ibg">${cartProductImage}</a>\n\t\t\t\t<div class="cart-list__body">\n\t\t\t\t<a href="" class="cart-list__title">${cartProductTitle}</a>\n\t\t\t\t<div class="cart-list__price">Price: <span>${productPrice}</span></div>\n\t\t\t\t<div class="cart-list__quantity">Quantity: <span>1</span></div>\n\t\t\t\t<a href="" class="cart-list__delete">Delete</a>\n\t\t\t\t</div>`;
                ...
                cartPrice.innerHTML = (+cartPrice.innerHTML - +productPrice).toFixed(2);
                if (cartQuantityValue) cartQuantity.innerHTML = cartQuantityValue; else cart.classList.remove("_active");
            }
        }
    };
    window["FLS"] = true;
